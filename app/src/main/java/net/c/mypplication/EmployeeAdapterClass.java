...
public class EmployeeAdapterClass extends RecyclerView.Adapter<EmployeeAdapterClass.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.button_Edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String stringPrix = holder.editText_prix.getText().toString();
                String stringSurface = holder.edittext_surface.getText().toString();
                String stringNBPiece= holder.edittext_nbPiece.getText().toString();

                databaseHelperClass.updateEmployee(new EmployeeModelClass(employeeModelClass.getId(),stringVille,stringPrix,stringSurface,stringNBPiece));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            button_delete = itemView.findViewById(R.id.button_edit);
